...
class KiwifyController extends Controller
{
    ...
    private function isValidKiwifyRequest(Request $request)
    {
        ...
        if (empty($secretKey1) && empty($secretKey2) && empty($secretKey3) && empty($secretKey4) && empty($secretKey5) && empty($secretKey6) && empty($secretKey7) && empty($secretKey8) && empty($secretKey9) && empty($secretKey10) && empty($secretKey11) && empty($secretKey12)) {
        ...
        if (!hash_equals($signature, $calculatedSignature1) && !hash_equals($signature, $calculatedSignature2) && !hash_equals($signature, $calculatedSignature3) && !hash_equals($signature, $calculatedSignature4) && !hash_equals($signature, $calculatedSignature5) && !hash_equals($signature, $calculatedSignature6) && !hash_equals($signature, $calculatedSignature7) && !hash_equals($signature, $calculatedSignature8) && !hash_equals($signature, $calculatedSignature9) && !hash_equals($signature, $calculatedSignature10) && !hash_equals($signature, $calculatedSignature11) && !hash_equals($signature, $calculatedSignature12)) {
