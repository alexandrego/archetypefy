...
<body>
    ...
    <div style="width:100%;margin:20px 0;font-size:16px;align-items:center;color:#000;">
            Seu comportamento principal é: <span style="font-size:18px"><strong>{{ session('resultadoFinalComportamento') }}</strong>
    </div>

    <div style="width:100%;font-size:15px;text-align:justify;color:#000;">
            O comportamento {{ session('resultadoFinalComportamento') }} descreve uma pessoa que é....
    </div>
