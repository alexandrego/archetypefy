            ...
            <form action="/question17" method="POST" onsubmit="avancando()">
                ...
                <div class="message roboto-thin messageStartTest">
                    ...
                    <div class="respostas">
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question17" id="a" value="a" required/><label for="a">Está descobrindo novos lugares e culturas</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question17" id="b" value="b" required/><label for="b">Está ajudando alguém em necessidade</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question17" id="c" value="c" required/><label for="c">Está ganhando uma competição</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question17" id="d" value="d" required/><label for="d">Está meditando ou relaxando</label>
                            </div>
                        @endif
                    </div>
                </div>
