            ...
            <form action="/question33" method="POST" onsubmit="avancando()">
                ...
                <div class="message roboto-thin messageStartTest">
                    ...
                    <div class="respostas">
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question33" id="a" value="a" /><label for="a">Fazer os outros rirem</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question33" id="b" value="b" /><label for="b">Ajudar os outros a se sentirem bem</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question33" id="c" value="c" /><label for="c">Liderar o grupo</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question33" id="d" value="d" /><label for="d">Explorar novas ideias e atividades</label>
                            </div>
                        @endif
                    </div>
                </div>
