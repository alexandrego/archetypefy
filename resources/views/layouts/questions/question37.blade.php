        ...
        <div id="formularioQuestions" class="formularioQuestions">
            <form action="/question37" method="POST" onsubmit="avancando()">
                ...
                <div class="message roboto-thin messageStartTest">
                    ...
                    <div class="respostas">
                        @if(session('answer37')=='a')
                            <div class="questions checked">
                                <input type="radio" name="question37" id="a" value="a" checked /><label for="a">Está aprendendo algo novo</label>
                            </div>
                        @else
                            <div class="questions">
                                <input type="radio" name="question37" id="a" value="a" required/><label for="a">Está aprendendo algo novo</label>
                            </div>
                        @endif

                        @if(session('answer37')=='b')
                            <div class="questions checked">
                                <input type="radio" name="question37" id="b" value="b" checked /><label for="b">Está ajudando alguém a entender algo</label>
                            </div>
                        @else
                            <div class="questions">
                                <input type="radio" name="question37" id="b" value="b" required/><label for="b">Está ajudando alguém a entender algo</label>
                            </div>
                        @endif

                        @if(session('answer37')=='c')
                            <div class="questions checked">
                                <input type="radio" name="question37" id="c" value="c" checked /><label for="c">Está vencendo um debate ou discussão</label>
                            </div>
                        @else
                            <div class="questions">
                                <input type="radio" name="question37" id="c" value="c" required/><label for="c">Está vencendo um debate ou discussão</label>
                            </div>
                        @endif

                        @if(session('answer37')=='d')
                            <div class="questions checked">
                                <input type="radio" name="question37" id="d" value="d" checked /><label for="d">Está explorando novas ideias</label>
                            </div>
                        @else
                            <div class="questions">
                                <input type="radio" name="question37" id="d" value="d" required/><label for="d">Está explorando novas ideias</label>
                            </div>
                        @endif
                    </div>
                </div>
