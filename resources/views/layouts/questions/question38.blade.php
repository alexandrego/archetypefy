            ...
            <form action="/question38" method="POST" onsubmit="avancando()">
                ...
                <div class="message roboto-thin messageStartTest">
                    ...
                    <div class="respostas">
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question38" id="a" value="a" /><label for="a">Conhecimento e sabedoria</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question38" id="b" value="b" /><label for="b">Empatia e compaixão</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question38" id="c" value="c" /><label for="c">Determinação e coragem</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question38" id="d" value="d" /><label for="d">Curiosidade e exploração</label>
                            </div>
                        @endif
                    </div>
                </div>
