            ...
            <form action="/question26" method="POST" onsubmit="avancando()">
                ...
                <div class="message roboto-thin messageStartTest">
                    ...
                    <div class="respostas">
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question26" id="a" value="a" required/><label for="a">Capacidade de amar profundamente</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question26" id="b" value="b" required/><label for="b">Desejo de ajudar os outros</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question26" id="c" value="c" required/><label for="c">Determinação e coragem</label>
                            </div>
                        @endif
                        ...
                        @else
                            <div class="questions">
                                <input type="radio" name="question26" id="d" value="d" required/><label for="d">Curiosidade e busca por novidades</label>
                            </div>
                        @endif
                    </div>
                </div>
